              ...
              <ul class="participants-list" style="list-style: none; padding-left: 0;">
                ${details.participants.map(email => `
                  <li class="participant-item" style="display: flex; align-items: center; gap: 0.5em;">
                    <span>${email}</span>
                    <span class="delete-participant" title="Remove participant" data-activity="${encodeURIComponent(name)}" data-email="${encodeURIComponent(email)}" style="cursor:pointer;color:#c00;font-weight:bold;">&times;</span>
                  </li>
                `).join("")}
              </ul>
            </div>
